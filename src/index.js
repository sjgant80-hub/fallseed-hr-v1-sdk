// fallseed-hr-v1 SDK · sovereign single-file library · MIT · AI-Native Solutions
// Extracted from fallseed-hr-v1/index.html · 100153 bytes of source logic
...
(function (root) {
  ...
  (function () {
    function go() { if (typeof FallKit !== 'undefined') FallKit.init({ seedName: "fallseed-hr-v1" }); }
    else go();
  })();
'use strict';
// ═══════════════════════════════════════════════════════════════
...
const SEED_DEFAULT = {
 manifest: {
 name: 'hr-firm', vertical: 'HR · payroll · employment', version: '2.0.0', prime: 1049,
    level: 0,
    parent: null,
 primeWindow: [1009, 1013, 1019, 1021],
 ...
 baseTools: [
 { role: 'anchor', name: 'fallhr', prime: 1009, url: 'https://sjgant80-hub.github.io/fallhr/',
 purpose: 'Employee register · holiday tracker · absence (Bradford Factor) · reviews · contracts · 12-pt compliance' },
 { role: 'onboard', name: 'fallhronboard', prime: 1013, url: 'https://sjgant80-hub.github.io/fallhronboard/',
 purpose: '7-step new starter wizard · personal · job · RTW · HMRC starter · bank · pension · consent' },
 { role: 'paper', name: 'fallhrpaper', prime: 1019, url: 'https://sjgant80-hub.github.io/fallhrpaper/',
 purpose: '8 document templates · offer · S.1 · contract · disciplinary · grievance · redundancy · settlement · reference' },
 { role: 'practice', name: 'fallhrpractice', prime: 1021, url: 'https://sjgant80-hub.github.io/fallhrpractice/',
 purpose: 'Payroll PAYE/NI/pension · holiday accrual · SSP · HMRC returns (FPS/EPS/P60/P11D) · 13-pt compliance' }
 ],
 t0Rules: [
 { pattern: 's\\.?1|statement of particulars|day.?one', answer: 'ERA 1996 s.1: written statement of employment particulars must be issued to ALL workers on or before day one. Day-one right since 6 Apr 2020. Failure: tribunal award 2-4 weeks pay.' },
 { pattern: 'rtw|right.?to.?work|immigration', answer: 'Immigration, Asylum and Nationality Act 2006: verify Right to Work BEFORE engagement. UK/Irish passport, share code, BRP, visa. Keep copies duration + 2 years. Civil penalty up to £45,000 per illegal worker.' },
 { pattern: 'pension|auto.?enrol', answer: 'Pensions Act 2008: auto-enrol eligible jobholders (22+ earning £10k+). Employer 3%, employee 5%. Qualifying earnings £6,240-£50,270. Re-enrol every 3 years.' },
 { pattern: 'wtr|working.?time|48|holiday', answer: 'WTR 1998: 48-hr weekly max unless opted out. 5.6 weeks paid holiday. Rest breaks: 20 min over 6 hrs. Daily rest 11 hrs.' },
 { pattern: 'ssp|sick.?pay', answer: 'SSP £118.75/week (2025/26). 3 waiting days. Max 28 weeks. Self-cert days 1-7, fit note day 8+.' },
 { pattern: 'redund|notice|dismiss|unfair', answer: 'Redundancy: 2-year qualifying. 0.5/1/1.5 weeks per year under 22/22-40/41+, capped £719/week, 20 years max. Unfair dismissal: 2 years qualifying. Notice: 1 wk (1mo-2yr), then 1/yr up to 12 wks.' },
 { pattern: 'equality|discriminat|harass', answer: 'Equality Act 2010: 9 protected characteristics. Worker Protection Act 2023: positive duty to prevent sexual harassment from 26 Oct 2024. Tribunal awards uncapped for discrimination.' },
 { pattern: 'paye|rti|p60|p11d|fps|eps', answer: 'RTI: FPS on/before payday. EPS by 19th of following month. P60 by 31 May. P11D by 6 July. Class 1A NIC by 22 July.' },
 { pattern: 'acas|disciplin|grieve', answer: 'ACAS Code: investigate → invite to hearing with allegations + right to be accompanied → decide → notify with right of appeal. Unreasonable non-compliance: tribunal uplift up to 25%.' },
 { pattern: 'min.?wage|nmw|nlw', answer: 'NLW £11.44/hr (21+) Apr 2024. 18-20 £8.60, 16-17 £6.40, Apprentice £6.40. Records 6 years.' },
 { pattern: 'gdpr|privacy|article 13', answer: 'UK GDPR Art.13: privacy notice at collection. Lawful basis: contract Art.6(1)(b) + legitimate interest Art.6(1)(f). Rights: access, rectification, erasure, portability, objection.' },
 { pattern: 'dse|display.?screen|workstation', answer: 'H&S (Display Screen Equipment) Regulations 1992. Employer must: assess DSE workstations, plan work breaks, provide eye tests on request.' }
 ],
 complianceItems: [
 'S.1 written statement of particulars (day 1) — ERA 1996 s.1',
 'Right to Work checks complete — Immigration Act 2006',
 'Auto-enrolment pension scheme — Pensions Act 2008',
 'Working Time opt-outs documented (if >48hrs) — WTR 1998',
 'Employee privacy notice — UK GDPR Art.13',
 'Disciplinary & grievance procedure — ACAS Code',
 'Equality, diversity, anti-harassment policy — Equality Act 2010 + Worker Protection Act 2023',
 'Health & Safety policy (if 5+ employees) — HSWA 1974',
 'Employers Liability insurance (£5M min) — EL(CI) Act 1969',
 'PAYE/RTI registered with HMRC',
 'National Minimum/Living Wage compliance',
 'Gender pay gap reporting (if 250+ employees)',
 'DSE workstation assessments — H&S DSE Regs 1992'
 ],
 documentClauses: [
 { code: 'S1-MANDATORY', text: 'Under Employment Rights Act 1996 s.1, this statement constitutes the principal statement of employment particulars and must be issued on or before the first day of work.' },
 { code: 'ACAS-DG', text: 'This procedure follows the ACAS Code of Practice on Disciplinary and Grievance Procedures.' },
 { code: 'S203-WAIVER', text: 'This Agreement complies with the statutory requirements under Employment Rights Act 1996 s.203.' },
 { code: 'ARRBYACCOMPANIED', text: 'You have the right to be accompanied by a fellow worker, trade union official, or certified trade union representative (Employment Relations Act 1999 s.10).' },
 { code: 'GDPR-NOTICE', text: 'Personal data is processed for employment services. Lawful basis: Art.6(1)(b) contract + Art.6(1)(f) legitimate interest. Retention: duration + 6 years.' }
 ],
 buildPromptSystem: `You are FallSeed-Build, the generative substrate of the FallSeed HR Firm wedge.
You generate sovereign single-HTML tools that extend an HR wedge for a UK SME. Every tool you produce MUST:
...
5. Open a BroadcastChannel named 'fall-hr' for mesh sync with the existing HR wedge.
...
8. Include a T0 Q&A panel that pattern-matches user questions against hard-coded UK HR rules.
...
15. Set <meta name="prime" content="XXXX"> where XXXX is one of: 1033, 1039, 1051, 1061, 1091, 1093, 1097, 1103, 1109.
16. Name the tool with prefix 'fallhr' (e.g. fallhrdse, fallhrtraining). Lowercase no-space single-word suffix.
...
function openDB() {
 ...
 const r = indexedDB.open('fallseed-hr-v2', 1);
 r.onupgradeneeded = e => {
...
function renderWelcome(v) {
 ...
 <div class="inspect-card"><div class="num">${totalCalls}</div>
    <div class="card" style="margin-top:18px">
      ...
      <p style="font-size:12px;color:var(--cream-dim);margin-bottom:8px">Level-0 vertical seed in the FallSeed family. Root seed (not forked).</p>
      ...
      <p style="font-size:11px;color:var(--cream-muted);font-family:var(--mono);letter-spacing:.06em">level <span style="color:var(--brass)">0</span> · parent <span style="color:var(--brass)">null</span> · MIT</p>
    </div>
    <div class="card" style="margin-top:18px">
...
async function provisionFirm() {
 ...
 try { new BroadcastChannel('fall-hr').postMessage({ v:1, type:'firm.provisioned', source:'fallseed-hr-v2', payload:{firm:f} }); } catch(e){}
...
OUTPUT the complete updated HTML file with the modification applied. Preserve everything that works. Start with <!DOCTYPE html>. End with </html>. No preamble. No code fences.`;
 ...
 const nameGuess = (titleMatch?.[1] || '').match(/fallhr\w*/i)?.[0] || 'fallhr_' + Math.random().toString(36).slice(2,7);
 lastGenerated = {
